...
Repositório base para jogo Unity 6 com multiplayer local. Este README atua apenas como **ponte** para a documentação canônica.

## Documentação canônica (NewScripts)
