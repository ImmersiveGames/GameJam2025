...
{
    public readonly struct GameplayPhaseRuntimeMaterializedEvent : ImmersiveGames.GameJam2025.Core.Events.IEvent
    {
    ...
    public readonly struct PhaseCompleted : ImmersiveGames.GameJam2025.Core.Events.IEvent
    {
