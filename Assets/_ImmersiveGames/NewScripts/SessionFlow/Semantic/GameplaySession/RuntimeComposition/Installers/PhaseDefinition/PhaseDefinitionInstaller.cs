...
{
    public sealed class PhaseContentSceneTransitionUnloadSupplementProvider : ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Transition.Runtime.ISceneTransitionUnloadSupplementProvider
    {
        public PhaseContentSceneTransitionUnloadSupplementProvider()
        {
            ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Transition.Runtime.SceneTransitionUnloadSupplementRegistry.Register(this);
        }

        public IReadOnlyList<string> GetSupplementalScenesToUnload(ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Transition.Runtime.SceneTransitionContext context)
        {
            if (context.RouteKind == ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Navigation.Runtime.SceneRouteKind.Gameplay)
            {
            ...
            {
                ImmersiveGames.GameJam2025.Core.Logging.DebugUtility.Log(typeof(PhaseContentSceneTransitionUnloadSupplementProvider),
                    ...
                    ImmersiveGames.GameJam2025.Core.Logging.DebugUtility.Colors.Info);
                return Array.Empty<string>();
            }
    ...
    {
        private readonly ImmersiveGames.GameJam2025.Core.Events.EventBinding<ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Transition.Runtime.SceneTransitionCompletedEvent> _sceneTransitionCompletedBinding;
        private bool _disposed;

        public PhaseContentSceneTransitionCompletionCleaner()
        {
            _sceneTransitionCompletedBinding = new ImmersiveGames.GameJam2025.Core.Events.EventBinding<ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Transition.Runtime.SceneTransitionCompletedEvent>(OnSceneTransitionCompleted);
            ImmersiveGames.GameJam2025.Core.Events.EventBus<ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Transition.Runtime.SceneTransitionCompletedEvent>.Register(_sceneTransitionCompletedBinding);
        }

        private static bool ShouldClearOnSceneTransitionCompleted(ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Transition.Runtime.SceneTransitionContext context)
        {
            return context.RouteKind != ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Navigation.Runtime.SceneRouteKind.Gameplay;
        }

        private void OnSceneTransitionCompleted(ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Transition.Runtime.SceneTransitionCompletedEvent evt)
        {
            if (_disposed)
            {
                return;
            ...
            ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Transition.Runtime.SceneTransitionContext context = evt.context;
            ...
            if (!PhaseContentSceneRuntimeApplier.HasActiveAppliedPhaseContent)
            {
                ImmersiveGames.GameJam2025.Core.Logging.DebugUtility.Log(typeof(PhaseContentSceneTransitionCompletionCleaner),
        ...
        public void Dispose()
        {
            ...
            _disposed = true;
            ImmersiveGames.GameJam2025.Core.Events.EventBus<ImmersiveGames.GameJam2025.Orchestration.SceneFlow.Transition.Runtime.SceneTransitionCompletedEvent>.Unregister(_sceneTransitionCompletedBinding);
        }
    }
}
