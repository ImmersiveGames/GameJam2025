...
using UnityEngine;
namespace _ImmersiveGames.NewScripts.Runtime.Actors.Player.Movement
{
    /// <summary>
    ...
    public sealed class PlayerMovementController : MonoBehaviour, IGameplayResettable, IGameplayResetTargetFilter, IGameplayResetOrder
    {
        [Header("Movement")]
        [SerializeField]
        ...
        private bool GetCachedMoveAllowed()
        {
            ...
            _cachedMoveAllowed = _stateService == null || _stateService.CanExecuteGameplayAction(GameplayAction.Move);
            return _cachedMoveAllowed;
        }
        ...
        private void EnableInputIfAllowed()
        {
            ...
            bool allowByState = _stateService == null || _stateService.CanExecuteGameplayAction(GameplayAction.Move);
            bool allow = _gateOpen && allowByState;
            inputReader.SetInputEnabled(allow);
        }
