    ...
    public static class GameLoopBootstrap
    {
        ...
        public static void EnsureRegistered()
        {
            ...
            if (!DependencyManager.Provider.TryGetGlobal<IGameLoopService>(out var existing))
            {
                ...
                service.Initialize();
                DebugUtility.LogVerbose<GameLoopBootstrap>("IGameLoopService registrado e inicializado.");
            }
            else
            {
                DebugUtility.LogVerbose<GameLoopBootstrap>("IGameLoopService já estava registrado.");
            }
