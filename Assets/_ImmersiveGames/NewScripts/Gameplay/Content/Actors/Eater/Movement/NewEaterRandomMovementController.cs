...
using UnityEngine;
namespace _ImmersiveGames.NewScripts.Gameplay.Content.Actors.Eater.Movement
{
    /// <summary>
    ...
    public sealed class NewEaterRandomMovementController : MonoBehaviour
    {
        [Header("Movement")]
        [SerializeField]
        ...
        private void Update()
        {
            ...
            if (!_stateService.CanExecuteAction(ActionType.Move))
            {
                LogStateBlockedOnce();
                return;
            }
            ...
            if (_timeToNextDirection <= 0f)
            {
                ...
                DebugUtility.LogVerbose<NewEaterRandomMovementController>(
        ...
        private void ResolveStateServiceOrDisable()
        {
            ...
            DebugUtility.LogWarning(typeof(NewEaterRandomMovementController),
