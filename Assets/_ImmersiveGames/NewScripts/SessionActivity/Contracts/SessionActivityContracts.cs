...
namespace _ImmersiveGames.NewScripts.SessionActivity.Contracts
{
    ...
    public enum SessionActivityStage
    {
        ...
        NonPlayerActorDiscoveryStarted = 92,
        NonPlayerActorDiscovered = 93,
        NonPlayerActorDiscoveryCompleted = 94,
        NonPlayerActorDiscoverySkipped = 95,
        NonPlayerActorDiscoveryFailed = 96,
        NonPlayerActorPresentationSetupStarted = 97,
        NonPlayerActorPresentationPlanResolved = 98,
        NonPlayerActorPresentationMaterialized = 99,
        NonPlayerActorPresentationReady = 100,
        NonPlayerActorPresentationRetained = 101,
        NonPlayerActorPresentationSetupSkippedOptional = 102,
        NonPlayerActorPresentationSetupFailed = 103,
        NonPlayerActorPresentationSetupCompleted = 104,
        NonPlayerActorPresentationReleaseStarted = 105,
        NonPlayerActorPresentationReleased = 106,
        NonPlayerActorPresentationReleaseSkipped = 107,
        NonPlayerActorPresentationReleaseFailed = 108,
        NonPlayerActorPresentationReleaseCompleted = 109,
        NonPlayerActorParticipationEnterStarted = 110,
        NonPlayerActorParticipationEntered = 111,
        NonPlayerActorReady = 112,
        NonPlayerActorParticipationExitStarted = 113,
        NonPlayerActorParticipationExited = 114,
        NonPlayerActorParticipationSkipped = 115,
        NonPlayerActorParticipationFailed = 116,
        NonPlayerActorAttributeSetupStarted = 117,
        NonPlayerActorAttributeProfileResolved = 118,
        NonPlayerActorAttributeReady = 119,
        NonPlayerActorAttributeSetupSkippedNoContent = 120,
        NonPlayerActorAttributeSetupFailed = 121,
        NonPlayerActorAttributeReleaseStarted = 122,
        NonPlayerActorAttributeReleased = 123,
        NonPlayerActorAttributeReleaseSkippedNoContent = 124,
        NonPlayerActorAttributeReleaseFailed = 125,
    }
    ...
    public enum SessionActivityFactKind
    {
        ...
        NonPlayerActorDiscoveryStarted = 207,
        NonPlayerActorDiscovered = 208,
        NonPlayerActorDiscoveryCompleted = 209,
        NonPlayerActorDiscoverySkipped = 210,
        NonPlayerActorDiscoveryFailed = 211,
        NonPlayerActorPresentationSetupStarted = 212,
        NonPlayerActorPresentationPlanResolved = 213,
        NonPlayerActorPresentationMaterialized = 214,
        NonPlayerActorPresentationReady = 215,
        NonPlayerActorPresentationRetained = 216,
        NonPlayerActorPresentationSetupSkippedOptional = 217,
        NonPlayerActorPresentationSetupFailed = 218,
        NonPlayerActorPresentationSetupCompleted = 219,
        NonPlayerActorPresentationReleaseStarted = 220,
        NonPlayerActorPresentationReleased = 221,
        NonPlayerActorPresentationReleaseSkipped = 222,
        NonPlayerActorPresentationReleaseFailed = 223,
        NonPlayerActorPresentationReleaseCompleted = 224,
        NonPlayerActorParticipationEnterStarted = 225,
        NonPlayerActorParticipationEntered = 226,
        NonPlayerActorReady = 227,
        NonPlayerActorParticipationExitStarted = 228,
        NonPlayerActorParticipationExited = 229,
        NonPlayerActorParticipationSkipped = 230,
        NonPlayerActorParticipationFailed = 231,
        NonPlayerActorAttributeSetupStarted = 232,
        NonPlayerActorAttributeProfileResolved = 233,
        NonPlayerActorAttributeReady = 234,
        NonPlayerActorAttributeSetupSkippedNoContent = 235,
        NonPlayerActorAttributeSetupFailed = 236,
        NonPlayerActorAttributeReleaseStarted = 237,
