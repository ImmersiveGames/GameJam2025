            ...
            List<SessionActivitySnapshot> snapshots)
        {
            ...
            for (int index = 0; index < participationResult.ActorResults.Count; index++)
            {
                ...
                if (actorResult.IsSkipped)
                {
                    ...
                    DebugUtility.Log(typeof(ActivityEntryActorParticipationStage), $"[OBS][ActivityEntryPipeline][ActorParticipation] event='ActorParticipationEnterSkipped' activityId='{definition.ActivityId}' entrySequence='{entrySequence}' owner='ActivityEntryPipeline' actorId='{instance.ActorId}' actorInstanceRuntimeId='{instance.ActorInstanceRuntimeId}' skipKind='{actorResult.SkipKind}' skipReason='{actorResult.ReasonCode}' source='{command.Source}' reason='{command.Reason}'.", DebugUtility.Colors.Warning);
                    continue;
                }
                ...
                if (actorResult.IsFailed)
                {
                    ...
                    DebugUtility.Log(typeof(ActivityEntryActorParticipationStage), $"[OBS][ActivityEntryPipeline][ActorParticipation] event='ActorParticipationEnterFailed' activityId='{definition.ActivityId}' entrySequence='{entrySequence}' owner='ActivityEntryPipeline' actorId='{instance.ActorId}' actorInstanceRuntimeId='{instance.ActorInstanceRuntimeId}' failureKind='{actorResult.SkipKind}' failureReason='{actorResult.ReasonCode}' source='{command.Source}' reason='{command.Reason}'.", DebugUtility.Colors.Error);
                ...
                DebugUtility.Log(typeof(ActivityEntryActorParticipationStage), $"[OBS][ActivityEntryPipeline][ActorParticipation] event='ActorParticipationEntered' activityId='{definition.ActivityId}' entrySequence='{entrySequence}' owner='ActivityEntryPipeline' actorId='{instance.ActorId}' actorInstanceRuntimeId='{actorInstanceRuntimeId}' actorRole='{instance.Role}' actorScope='{instance.Scope}' source='{command.Source}' reason='{command.Reason}'.", DebugUtility.Colors.Success);
                ...
                DebugUtility.Log(typeof(ActivityEntryActorParticipationStage), $"[OBS][ActivityEntryPipeline][ActorParticipation] event='ActorReady' activityId='{definition.ActivityId}' entrySequence='{entrySequence}' owner='ActivityEntryPipeline' actorId='{instance.ActorId}' actorInstanceRuntimeId='{actorInstanceRuntimeId}' actorRole='{instance.Role}' actorScope='{instance.Scope}' source='{command.Source}' reason='{command.Reason}'.", DebugUtility.Colors.Success);
            }
