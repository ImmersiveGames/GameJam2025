    ...
    internal static class ActivityEntryActorParticipationStage
    {
            ...
            List<SessionActivitySnapshot> snapshots)
        {
            ...
            for (int index = 0; index < participationResult.ActorResults.Count; index++)
            {
                ...
                DebugUtility.Log(typeof(ActivityEntryActorParticipationStage), $"[OBS][ActivityEntryPipeline][ActorParticipation] event='ActorParticipationEntered' activityId='{definition.ActivityId}' entrySequence='{entrySequence}' owner='ActivityEntryActorParticipationStage' entryPipelineOwner='ActivityEntryPipeline' actorId='{instance.ActorId}' actorInstanceRuntimeId='{actorInstanceRuntimeId}' actorRole='{instance.Role}' actorScope='{instance.Scope}' source='{command.Source}' reason='{command.Reason}'.", DebugUtility.Colors.Success);
                ...
                DebugUtility.Log(typeof(ActivityEntryActorParticipationStage), $"[OBS][ActivityEntryPipeline][ActorParticipation] event='ActorReady' activityId='{definition.ActivityId}' entrySequence='{entrySequence}' owner='ActivityEntryActorParticipationStage' entryPipelineOwner='ActivityEntryPipeline' actorId='{instance.ActorId}' actorInstanceRuntimeId='{actorInstanceRuntimeId}' actorRole='{instance.Role}' actorScope='{instance.Scope}' source='{command.Source}' reason='{command.Reason}'.", DebugUtility.Colors.Success);
            }
            ...
            DebugUtility.Log(typeof(ActivityEntryActorParticipationStage), $"[OBS][ActivityEntryPipeline][ActorParticipation] event='ActorParticipationEnterCompleted' activityId='{definition.ActivityId}' entrySequence='{entrySequence}' owner='ActivityEntryActorParticipationStage' entryPipelineOwner='ActivityEntryPipeline' total='{total}' entered='{entered}' skipped='{skipped}' failed='{failed}' source='{command.Source}' reason='{command.Reason}'.", DebugUtility.Colors.Success);
