...
{
    /// <summary>
    /// Coleta SceneFlowProfileId a partir do conjunto canonico + catalogos existentes.
    /// </summary>
    internal sealed class SceneFlowProfileIdSourceProvider : ISceneFlowIdSourceProvider<SceneFlowProfileId>
    {
