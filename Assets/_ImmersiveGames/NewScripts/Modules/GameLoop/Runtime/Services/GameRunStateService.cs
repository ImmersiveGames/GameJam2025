...
namespace _ImmersiveGames.NewScripts.Modules.GameLoop.Runtime.Services
{
    ...
    public sealed class GameRunStateService : IGameRunStateService, IDisposable
    {
        ...
        public GameRunStateService(IGameLoopService gameLoopService)
        {
        ...
        public void Clear()
        {
            ...
            DebugUtility.LogVerbose<GameRunStateService>(
                "[GameLoop] GameRunStateService.Clear() chamado. Resultado resetado para Unknown.");
        }
        ...
        private void OnGameRunStarted(GameRunStartedEvent evt)
        {
            ...
            DebugUtility.LogVerbose<GameRunStateService>(
                $"[GameLoop] GameRunStateService: nova run iniciada (state={evt?.StateId}). Resultado anterior resetado.");
        }
