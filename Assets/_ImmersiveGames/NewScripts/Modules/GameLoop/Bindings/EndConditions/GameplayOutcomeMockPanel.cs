...
namespace _ImmersiveGames.NewScripts.Modules.GameLoop.Bindings.EndConditions
{
    ...
    public sealed class GameplayOutcomeMockPanel : MonoBehaviour
    {
