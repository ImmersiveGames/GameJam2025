...
namespace _ImmersiveGames.NewScripts.Modules.Gameplay.RunRearm.Dev
{
    ...
    public sealed class RunRearmKindDevEaterActor : MonoBehaviour, IActor, IActorKindProvider, IRunRearmable
    {
        [SerializeField]
        ...
        public string DisplayName => string.IsNullOrWhiteSpace(displayName)
            ? (gameObject != null ? gameObject.name : nameof(RunRearmKindDevEaterActor))
            : displayName;
        ...
        private void LogStep(string step, RunRearmContext ctx)
        {
            ...
            DebugUtility.Log(typeof(RunRearmKindDevEaterActor),
