...
{
    public sealed class ActorGroupRearmSceneScanDiscoveryStrategy : IActorGroupRearmDiscoveryStrategy
    {
        private readonly string _sceneName;

        public ActorGroupRearmSceneScanDiscoveryStrategy(string sceneName)
        {
