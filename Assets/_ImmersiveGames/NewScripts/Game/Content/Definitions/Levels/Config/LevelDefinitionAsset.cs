...
namespace _ImmersiveGames.NewScripts.Game.Content.Definitions.Levels.Config
{
    [CreateAssetMenu(
        ...
        menuName = "ImmersiveGames/NewScripts/Game/Content/Definitions/Levels/LevelDefinitionAsset",
        order = 30)]
    public sealed class LevelDefinitionAsset : ScriptableObject
    {
        ...
        [SerializeField] private bool hasPostRunReactionHook = true;
        ...
        public bool HasPostRunReactionHook => hasPostRunReactionHook;
        public bool HasPostLevelStage => hasPostRunReactionHook;
