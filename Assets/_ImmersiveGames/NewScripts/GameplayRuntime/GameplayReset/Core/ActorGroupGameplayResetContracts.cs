...
namespace _ImmersiveGames.NewScripts.GameplayRuntime.GameplayReset.Core
{
    ...
    /// <summary>
    /// Policy padr�o do GameplayReset.
    ...
    /// <summary>
    /// Identificadores can�nicos de observabilidade para GameplayReset.
    /// </summary>
    ...
    /// <summary>
    /// Participante ass�ncrono de gameplay reset sobre um actor ja vivo,
    ...
    /// <summary>
    /// Participante s�ncrono sobre um actor ja vivo, materializado e registrado.
    ...
    /// <summary>
    /// Opcional: controla a ordem de execu��o dentro de cada etapa. Menor primeiro.
    /// </summary>
    ...
    public interface IActorGroupGameplayResetOrchestrator
    {
        ...
        /// Se j� houver reset em andamento, a implementa��o pode ignorar (retornando false) ou aguardar.
        /// </summary>
