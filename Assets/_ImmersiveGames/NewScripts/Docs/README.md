...
6. **Guides/UTILS-SYSTEMS-GUIDE.md** — infraestrutura transversal (DI/EventBus/Debug/Pooling).
7. **ADR/ADR-0001-NewScripts-Migracao-Legado.md** — estratégia e guardrails de migração/bridges temporários.
8. **GameLoop/GameLoop.md** — estado global do loop (Boot/Playing/Paused) e integração com gate.
9. **CHANGELOG-docs.md** — histórico das mudanças de documentação.
