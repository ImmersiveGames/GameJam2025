...
- **ContentSwap** permanece como executor técnico de troca de conteúdo (In-Place / SceneTransition), mantendo contratos públicos existentes.
...
- ADR-0017 (modos canônicos de ContentSwap): `../../ADRs/ADR-0017-Tipos-de-troca-conteudo.md`
