...
|---|---|---|---|---|---|
| **P-001** | **IN_PROGRESS** | Strings → Referências diretas (v1) | ADRs + Standards | Audits: `Reports/Audits/*StringsToDirectRefs*` | `Plan-Continuous.md#p-001` |
| **P-002** | **PROPOSED** | Data Cleanup pós v1 (remove resíduos/compat) | ADRs + Standards | Snapshot: `Reports/SceneFlow-Config-Snapshot-DataCleanup-v1.md` | `Plan-Continuous.md#p-002` |
| **P-003** | **BLOCKED** | Navegação: Play → `to-gameplay` (correção mínima) | ADRs + Standards | Audit: `Reports/Audits/2026-02-11/Audit-NavigationRuntime-Mismatch.md` | `Plan-Continuous.md#p-003` |
| **P-004** | **IN_PROGRESS** | Validação (Codex) — SceneFlow/RouteResetPolicy | ADRs + Standards | (pendente de audit datada) | `Plan-Continuous.md#p-004` |
