...
| **P-004** | **DONE** | Validação (Codex) — SceneFlow/RouteResetPolicy | ADRs + Standards | Audit datada: `Reports/Audits/2026-02-17/Audit-SceneFlow-RouteResetPolicy.md` | `Plan-Continuous.md#p-004` |
