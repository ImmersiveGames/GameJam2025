...
Historical index only. This file is kept for legacy reading, not as Baseline 4.0 authority.
...
- This index remains a snapshot of the older runtime-oriented reading order.
- If it conflicts with the canonical chain above, the canonical chain wins.
...
8. `Docs/Reports/Evidence/LATEST.md`
9. `Docs/CHANGELOG-docs.md`
