...
namespace _ImmersiveGames.NewScripts.Infrastructure.QA
{
    ...
    public sealed class LegacySceneFlowBridgeSmokeQATester : MonoBehaviour
    {
        ...
        [ContextMenu("QA/SceneFlow/Legacy Bridge/Run")]
        public void Run()
        {
            ResetState();
            RegisterBindings();
            ...
            try
            {
                ...
                // Observação: seus EventBus são síncronos na prática, mas mantemos o "wait" por segurança.
                WaitForDispatch();
                ValidateOrThrow();
            }
            finally
        ...
        private bool TryPublishLegacyEvents()
        {
            try
            {
                // Se esse ctor não existir no seu LegacyContext, o teste marca SKIP.
