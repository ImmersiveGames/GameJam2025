    ...
    public sealed class SessionOperationalRoutePlanResolver
    {
            ...
            IReadOnlyList<SceneKeyAsset> previousRouteOwnedLoadedSceneKeys)
        {
            ...
            var unloadPlan = ResolveRouteUnloadPlanOrFail(
                ...
                activeSceneName);
            var audioCommand = ResolveAudioCommandOrFail(route);
        ...
        {
            var routeAudioMode = route.RouteAudioMode;
            var routeAudioCue = routeAudioMode == SessionOperationalRouteAudioMode.Cue
                ? route.RouteAudioCue
                : null;
            ...
            string currentActiveSceneName)
        {
            ...
            {
                var sceneKey = previousSceneKeys[i];
