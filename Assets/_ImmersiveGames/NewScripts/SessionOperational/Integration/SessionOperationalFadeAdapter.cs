...
namespace _ImmersiveGames.NewScripts.SessionOperational.Integration
{
    ...
    public sealed class SessionOperationalFadeAdapter : ISessionOperationalFadeAdapter
    {
        ...
        private async Task ExecuteFadeAsync(SessionOperationalRouteCommand command, bool isFadeIn)
        {
            ...
            transitionProfile.ValidateOrFail(
                nameof(SessionOperationalFadeAdapter),
            ...
            DebugUtility.Log(typeof(SessionOperationalFadeAdapter),
            ...
            catch (Exception ex)
            {
                ...
                DebugUtility.LogError<SessionOperationalFadeAdapter>(message);
