...
{
    public interface ISessionOperationalLoadingAdapter
    {
    ...
    public sealed class Base11SandboxSessionOperationalLoadingAdapter : ISessionOperationalLoadingAdapter
    {
        ...
        public Task ShowLoadingAsync(SessionOperationalLoadingCommand command, SessionOperationalLoadingFact fact)
        {
            ...
            DebugUtility.Log(typeof(Base11SandboxSessionOperationalLoadingAdapter),
