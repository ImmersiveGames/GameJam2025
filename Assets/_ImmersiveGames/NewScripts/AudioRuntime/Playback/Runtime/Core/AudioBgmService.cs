...
{
    /// <summary>
    /// Runtime can�nico de BGM global (single-channel l�gico) para F3 do ADR-0028.
    /// Internamente usa duas fontes para suportar crossfade sem concorr�ncia estrutural de BGM.
    /// TODO: restaurar padr�o via AudioDefaultsAsset e expor preview de SFX no commit do slider.
    /// </summary>
