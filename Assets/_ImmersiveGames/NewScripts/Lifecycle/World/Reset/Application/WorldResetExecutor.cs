...
namespace _ImmersiveGames.NewScripts.Lifecycle.World.Reset.Application
{
    ...
    public sealed class WorldResetExecutor
    {
        ...
        private async Task EnsureEssentialSpawnsAsync(string targetScene, IResetPolicy policy)
        {
        ...
        private static void LogDegraded(IResetPolicy policy, string message)
        {
