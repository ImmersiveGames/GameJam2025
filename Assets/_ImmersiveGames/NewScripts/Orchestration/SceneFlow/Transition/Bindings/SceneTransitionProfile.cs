using UnityEngine;
namespace _ImmersiveGames.NewScripts.Orchestration.SceneFlow.Transition.Bindings
{
    /// <summary>
    ...
    [CreateAssetMenu(
        ...
        menuName = "ImmersiveGames/NewScripts/Orchestration/SceneFlow/Transition/Profiles/SceneTransitionProfile",
        order = 30)]
