...
namespace _ImmersiveGames.Scripts.FXSystems
{
    ...
    public class ExplosionEffect : PooledObject
    {
        ...
        public void ApplySoundOverride(SoundData sound)
        {
            if (audioController == null)
            {
                audioController = GetComponent<ExplosionAudioController>();
            ...
            audioController?.SetExplosionSound(sound);
        }

        private void ResetExplosionAudio()
        {
            if (audioController == null)
            {
                audioController = GetComponent<ExplosionAudioController>();
            ...
            audioController?.ResetExplosionSound();
        }
    }
}
