...
namespace _ImmersiveGames.Scripts.AudioSystem.Editor
{
    ...
    public class SoundDataEditor : UnityEditor.Editor
    {
        ...
        {
            DrawDefaultInspector(); // Mant�m inspector padr�o
        ...
        private static void ConfigureSourceFromData(AudioSource source, SoundData data)
        {
            ...
            // Configura��es-base do AudioSource respeitando SoundData
            ...
            // Configura��es de espacializa��o
            source.spatialBlend = data.spatialBlend;
            source.maxDistance = data.maxDistance;

            // Pitch aleat�rio quando configurado
            source.pitch = 1f;
            if (data.randomPitch)
            {
