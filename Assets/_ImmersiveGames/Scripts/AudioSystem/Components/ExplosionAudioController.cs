...
namespace _ImmersiveGames.Scripts.AudioSystem.Components
{
    ...
    public class ExplosionAudioController : AudioControllerBase
    {
        ...
        private SoundData _defaultExplosionSound;

        protected override void Awake()
        {
            base.Awake();
            _defaultExplosionSound = explosionSound;
        }
        ...
        {
            explosionSound = sound != null ? sound : _defaultExplosionSound;
        }

        public void ResetExplosionSound()
        {
            explosionSound = _defaultExplosionSound;
        }
    }
}
