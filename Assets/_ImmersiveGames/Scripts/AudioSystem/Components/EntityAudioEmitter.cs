...
namespace _ImmersiveGames.Scripts.AudioSystem
{
    ...
    public class EntityAudioEmitter : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (_sfxService == null)
            {
                DebugUtility.LogWarning<EntityAudioEmitter>(
                    $"[{name}] IAudioSfxService não encontrado — usando caminho legado de áudio local.",
                    this);
            }
        ...
        /// <summary>
        /// Reproduz um efeito sonoro local usando o serviço global quando disponível ou o caminho legado.
        /// </summary>
