...
namespace _ImmersiveGames.Scripts.StateMachineSystems
{
    ...
    /// <summary>
    /// Representa um predicado que garante a execu��o de uma a��o antes de avaliar o resultado concreto.
    /// </summary>
    public abstract class ActionPredicate : IPredicate
    {
        ...
        /// <summary>
        /// Avalia��o concreta realizada pelas classes derivadas ap�s a execu��o da a��o.
        /// </summary>
        /// <returns>Verdadeiro caso a transi��o deva ocorrer.</returns>
