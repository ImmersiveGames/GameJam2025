...
namespace _ImmersiveGames.Scripts.PlanetSystems.Defense
{
    ...
    public static class PlanetDefensePresetAdapter
    {
            ...
            PlanetDefenseLoadoutSo legacyLoadout = null)
        {
            if (planet == null)
            {
                DebugUtility.LogWarning(typeof(PlanetDefensePresetAdapter),"Tentativa de resolver preset com planeta nulo.");
                return null;
            }
            ...
            out CachedContext cached)
        {
            if (CachedContexts.TryGetValue(planet, out cached))
            {
                ...
                {
                    DebugUtility.LogVerbose(typeof(PlanetDefensePresetAdapter),
