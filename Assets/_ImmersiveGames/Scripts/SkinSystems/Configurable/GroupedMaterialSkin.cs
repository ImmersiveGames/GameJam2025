...
namespace _ImmersiveGames.Scripts.SkinSystems.Configurable
{
    public class GroupedMaterialSkin : SkinConfigurable
    {
        ...
        /// <summary>
        /// Aplica um material espec�fico a um grupo (todos os slots do grupo recebem o MESMO material)
        /// </summary>
        ...
        /// <summary>
        /// Randomiza os materiais de um grupo espec�fico - CADA SLOT SORTEIA INDEPENDENTEMENTE
        /// </summary>
        ...
        /// <summary>
        /// Aplica uma progress�o de materiais baseada em �ndice - TODOS OS SLOTS DO GRUPO RECEBEM O MESMO MATERIAL
        /// </summary>
        ...
        /// <summary>
        /// Reseta um grupo espec�fico para os materiais originais
        /// </summary>
        ...
        /// <summary>
        /// Obt�m os slots de um grupo espec�fico
        /// </summary>
        ...
        /// <summary>
        /// Obt�m o estado atual dos grupos
        /// </summary>
        ...
        /// <summary>
        /// Obt�m informa��es detalhadas sobre todos os slots
        /// </summary>
