...
namespace _ImmersiveGames.Scripts.SkinSystems.Configurable
{
    public class RandomTransformSkin : SkinConfigurable
    {
        ...
        /// <summary>
        /// Reseta todas as inst�ncias para suas transforma��es originais
        /// </summary>
        ...
        /// <summary>
        /// Obt�m a transforma��o aleat�ria atual
        /// </summary>
