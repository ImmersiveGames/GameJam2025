...
{
    [CreateAssetMenu(menuName = "ImmersiveGames/Predicates/Input (InputSystem)")]
    public class InputSystemPredicateSo : PredicateSo, IBindableInputPredicate
    {
        ...
        {
            return isActive && _action is { triggered: true };
        }
    }
}