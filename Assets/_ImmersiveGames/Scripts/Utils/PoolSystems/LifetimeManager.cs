...
namespace _ImmersiveGames.Scripts.Utils.PoolSystems
{
    ...
    public class LifetimeManager : PersistentSingleton<LifetimeManager>
    {
        ...
        private void Update()
        {
            ...
            // Usar ToList() para criar snapshot e evitar exce��es de modifica��o durante itera��o
            ...
            foreach ((var poolable, float f) in poolableEntries)
            {
                ...
                // Se o poolable foi destru�do (mas a refer�ncia ainda existe), remove da lista
            ...
            foreach (var poolable in _objectsToRemove)
            {
                if (IsPoolableDestroyed(poolable))
                {
                    // Para objetos nulos/destru�dos, apenas remove do dicion�rio
        ...
        /// <summary>
        /// Trata corretamente refer�ncias destru�das (UnityEngine.Object) mesmo quando tipadas como interface.
        /// </summary>
