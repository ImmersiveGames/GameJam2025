...
| `EaterChasingState` | Persegue o planeta atualmente marcado, verifica se o alvo já está no sensor, congela a órbita quando entra em alcance e transfere o eater para o estado de alimentação. |
