...
{
    /// <summary>
    /// Parte da implementa��o do Eater focada em:
    /// - sistema de desejos (EaterDesireService / EaterDesireInfo);
    /// - helpers de mundo: players, �rbita e movimenta��o utilit�ria.
    /// </summary>
    public sealed partial class EaterBehavior : MonoBehaviour
    {
        ...
        /// <summary>
        /// Registra informa��es sobre o �ltimo ponto em que a persegui��o foi interrompida.
        /// Mant�m a dist�ncia radial calculada a partir do centro do planeta e a separa��o da superf�cie.
        /// </summary>
        ...
        /// <summary>
        /// Obt�m o �ltimo ponto de parada registrado para o planeta informado.
        /// </summary>
        ...
        internal bool SuspendDesires(string reason)
        {
            ...
            {
                DebugUtility.LogVerbose($"Desejos suspensos mantendo sele��o atual ({reason}).", DebugUtility.Colors.CrucialInfo, this, this);
            }
        ...
        private bool EnsureDesireService()
        {
            ...
            if (Master == null || Config == null)
            {
                ...
                {
                    DebugUtility.LogWarning("N�o foi poss�vel inicializar o servi�o de desejos (Master ou Config ausentes).", this, this);
